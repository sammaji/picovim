			...
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(ev)
					...
					vim.keymap.set(
						...
						utils.desc(opts, "Show LSP references (every single place where this symbol is being used)")
					...
					vim.keymap.set(
						...
						utils.desc(
							opts,
							"Show LSP definitions (place where a variable, function, or class was created)"
						)
					...
					vim.keymap.set(
						...
						utils.desc(opts, "Show LSP implementations (places where classes / traits are implemented)")
					) -- show lsp implementations
					vim.keymap.set(
						"n",
						"gt",
						"<cmd>Telescope lsp_type_definitions<CR>",
						utils.desc(opts, "Show LSP type definitions")
					) -- show lsp type definitions
					vim.keymap.set(
						{ "n", "v" },
						"gca",
						vim.lsp.buf.code_action,
						utils.desc(opts, "See available code actions")
					) -- see available code actions, in visual mode will apply to selection
					vim.keymap.set("n", "grn", vim.lsp.buf.rename, utils.desc(opts, "Smart rename")) -- smart rename

					vim.keymap.set("n", "ge", vim.diagnostic.open_float, utils.desc(opts, "Show diagnostics for line"))
					vim.keymap.set(
						"n",
						"gE",
					...
					end, utils.desc(opts, "Go to previous diagnostic"))
					vim.keymap.set("n", "gh", function()
						vim.diagnostic.jump({ count = 1, float = true })
					end, utils.desc(opts, "Go to next diagnostic"))

					vim.keymap.set("n", "g\\", vim.lsp.buf.hover, utils.desc(opts, "Show documentation")) -- show documentation for what is under cursor
				...
				mason_lspconfig.setup_handlers({
					...
					["eslint"] = function()
						lspconfig["eslint"].setup({
							capabilities = capabilities,
							-- Tells the server where the project root is (looks for package.json or .eslintrc)
							...
							settings = {
								-- Auto-discovery of working directories (essential for monorepos)
